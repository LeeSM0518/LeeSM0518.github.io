...
장치 간의 **점대점 연결을** 위한 프로토콜

* 전화선 또는 케이블 모뎀을 이용하여 인터넷 연결
  * 흐름 제어 제공 X
  * CRC를 이용한 오류 제어
  * 프레임 손상시 버리고 상위 층 프로토콜이 해결
  * 순서 번호가 없다.
  * 주소 지정 방식이 없다.
...
<img src="../capture/스크린샷 2019-06-09 오전 2.56.41.png">



### 11.4.2. LCP(Link Control Protocol)

**LCP** : 두 단말 사이에 <u>연결을 설정하고, 유지하고 구성하고, 종료</u> 하는 기능을 수행
...
<img src="../capture/스크린샷 2019-06-09 오후 4.28.29.png">

* **Information** : 연결 협상에 필요한 선택사항 포함
* **codes** : 코드들에 따라 설정, 해제, 감시 및 디버깅을 할 수 있다.
...
* **선택 사항** : 두 단말 사이에 <u>협상이 이루어져야 하는 사항들로</u> 구성 패킷의 정보 필드에 들어 있다.

<img src="../capture/스크린샷 2019-06-09 오후 4.32.35.png">

* **Maximum receive unit** : 최대 수신 단위
* **Authentication protocol** : 입증 프로토콜
* **Protocol field compression** : 프로토콜 필드 압축
* **Address and control field compression** : 주소 및 제어 필드 압축
...
* **Authentication** : 사용자의 신원을 증명하는 것
* **PAP (Password Authentication Protocol)** : 패스워드 인증 방식

<img src="../capture/스크린샷 2019-06-09 오후 4.38.43.png">
...
<img src="../capture/스크린샷 2019-06-09 오후 4.39.51.png">

* **Authenticate-request** : 신원 증명 요청
* **Authenticate-ack** : 유저 허용 O
* **Authenticate-nak** : 유저 허용 X
...
: 이 프로토콜을 이용하여 여러가지 네트워크 계층 프로토콜(IP, IPX, AppleTalk, etc)의 데이터를 전송한다.

* **IPCP (Internet Protocol Control Protocol)**
  * <u>IP 패킷 전달</u> 을 위한 프로토콜
  * 프로토콜 필드값 <u>0x8021</u> 사용
...
<img src="../capture/스크린샷 2019-06-09 오후 5.35.10.png">

* **LCP** : 연결 설정
* **AP** : 유저 인증
* **NCP** : 네트워크 계층의 연결/해제 제어
* **LCP** : 연결 해제



<img src="../capture/스크린샷 2019-06-09 오후 5.42.42.png">
